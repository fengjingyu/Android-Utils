package com.xiaocoder.utils.function.scroller;
...
public class ScrollerPlus extends Scroller {
    ...
    public ScrollerPlus(Context context) {
        super(context);
    }

    public ScrollerPlus(Context context, Interpolator interpolator) {
        super(context, interpolator);
    }

    public ScrollerPlus(Context context, Interpolator interpolator, boolean flywheel) {
