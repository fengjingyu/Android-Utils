...
/**
 private void tab() {
 viewPager.setAdapter(new AdapterViewPagerFragment(getSupportFragmentManager(), initFragments(), getTitles()));
 ...
 // 设置Tab Indicator的颜色
 tab.setIndicatorColor(Color.parseColor("#37b589"));
 tab.setSelectedTextColor(Color.parseColor("#35b688"));
...
public class PagerSlidingTab extends HorizontalScrollView {
	...
	public PagerSlidingTab(Context context, AttributeSet attrs, int defStyle) {
		...
		tabTextColor = a.getColor(R.styleable.PagerSlidingTab_pstsIndicatorColor, tabTextColor);
