package com.jingyu.android.roundimg;
 ...
 * app:sriv_oval="true"
 * <p>
 * RoundedImageView sriv = new RoundedImageView(context);
    ...
    private Drawable resolveResource() {
        ...
        if (mResource != 0) {
            try {
                ...
                //Logger.e("SelectableRoundedImageView---Unable to find resource: " + mResource, e);
                // Don't try again.
                mResource = 0;
            }
        }
        ...
        public static Drawable fromDrawable(Drawable drawable, Resources r) {
            if (drawable != null) {
                ...
                if (bm != null) {
                    ...
                    //Logger.e("SelectableRoundedImageView---Failed to create bitmap from drawable!");
                }
            }
            return drawable;
        }
